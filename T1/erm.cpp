...
//                case 8: v=ERMVarF[vnt->Num-1]; break; // e
					...
					case 'X': // X#
						...
						}else{ WL_MError1("\"String 2ERM\"-wrong %X# number (1...16).\nParameter value: %d",v); }
						break;
					case 'Y': // Y#
						++i;
						v=a2i(&str[i]); i+=SkipNumbers(&str[i])-1;
